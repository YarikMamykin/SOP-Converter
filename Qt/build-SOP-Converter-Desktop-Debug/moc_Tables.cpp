...
struct qt_meta_stringdata_Ui__SetTable__Cell_t {
    QByteArrayData data[1];
    char stringdata[20];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_Ui__SetTable__Cell_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_Ui__SetTable__Cell_t qt_meta_stringdata_Ui__SetTable__Cell = {
    {
...
static const uint qt_meta_data_Ui__SetTable__Cell[] = {
...
void Ui::SetTable::Cell::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject Ui::SetTable::Cell::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Ui__SetTable__Cell.data,
      qt_meta_data_Ui__SetTable__Cell,  qt_static_metacall, 0, 0}
};


const QMetaObject *Ui::SetTable::Cell::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *Ui::SetTable::Cell::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Ui__SetTable__Cell.stringdata))
        return static_cast<void*>(const_cast< Cell*>(this));
    return QObject::qt_metacast(_clname);
}

int Ui::SetTable::Cell::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
