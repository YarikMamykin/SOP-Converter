...
points = [ geompy.MakeVertex(box_final_coords[0]/2,box_final_coords[1],box_final_coords[2]-130) , geompy.MakeVertex(box_final_coords[0]/2,box_final_coords[1],box_final_coords[2]-20) ]
